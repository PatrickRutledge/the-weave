...
const orchestrator_js_1 = require("./weaver/orchestrator.js");
const state_manager_js_1 = require("./weaver/state-manager.js");
const deployment_analyzer_js_1 = require("./tools/deployment-analyzer.js");
const branch_checker_js_1 = require("./tools/branch-checker.js");
const git_pattern_detector_js_1 = require("./tools/git-pattern-detector.js");
const weave_loader_js_1 = require("./resources/weave-loader.js");
const agent_instructions_js_1 = require("./resources/agent-instructions.js");
...
const stateManager = new state_manager_js_1.StateManager();
const weaverOrchestrator = new orchestrator_js_1.WeaverOrchestrator(stateManager);
const deploymentAnalyzer = new deployment_analyzer_js_1.DeploymentAnalyzer();
const branchChecker = new branch_checker_js_1.BranchChecker();
const gitPatternDetector = new git_pattern_detector_js_1.GitPatternDetector();
const weaveLoader = new weave_loader_js_1.WeaveLoader();
const agentInstructions = new agent_instructions_js_1.AgentInstructions();
// BMAD-inspired activation sequence
async function activateAgent(agentType) {
